    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_owner', models.ManyToManyField(to='app.carowner')),
                ('id_vehicle', models.ManyToManyField(to='app.vehicle')),
            ],
        ),
        migrations.CreateModel(
            name='DriverLicense',
            fields=[
                ...
                ('id_owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.carowner')),
            ],
        ),
    ]
