    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pr2_2.car')),
                ('owner_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pr2_2.owner')),
            ],
        ),
        migrations.CreateModel(
            name='DrivingLicense',
            fields=[
                ...
                ('owner_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='pr2_2.owner')),
            ],
        ),
    ]
