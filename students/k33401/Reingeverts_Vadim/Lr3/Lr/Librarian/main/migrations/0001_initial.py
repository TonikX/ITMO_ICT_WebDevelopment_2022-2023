    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_amount', models.IntegerField(default=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reading_room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.readingroom')),
            ],
        ),
        migrations.CreateModel(
            name='BookUser',
            fields=[
                ...
                ('returned_date', models.DateField(blank=True, default=datetime.date.today, null=True)),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.book')),
        ...
        migrations.AddField(
            model_name='book',
            name='borrowers',
            field=models.ManyToManyField(blank=True, through='main.BookUser', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='book',
            name='reading_rooms',
