    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api_url', models.CharField(blank=True, default='https://airlabs.co/api/v9/airports?', max_length=100)),
                ('api_key', models.CharField(blank=True, default='4a84701d-216b-4db5-a5f6-5b69f85fe6d7', max_length=100)),
        ...
        migrations.AddField(
            model_name='flight',
            name='reservators',
            field=models.ManyToManyField(blank=True, through='main.FlightUser', to=settings.AUTH_USER_MODEL),
        ),
