...
<v-card-title>
      ...
      <v-card-text>
        <div class="text--primary">
            ...
            <b>Еще:</b>  {{ this.book.book_cypher }} <br>
          <br>
          <v-text-field
            label="Дата выдачи"
...
export default {
  ...
  methods: {
    ...
    async takeBook () {
      ...
      this.submitForm.id_copy = 1
      // console.log(this.submitForm)
      console.log('Sumbit form', this.submitForm)
      // await axios.post('http://127.0.0.1:8000/library/take_out/', this.submitForm)
      await axios.post('http://127.0.0.1:8000/library/readers-book/create/', this.submitForm)
