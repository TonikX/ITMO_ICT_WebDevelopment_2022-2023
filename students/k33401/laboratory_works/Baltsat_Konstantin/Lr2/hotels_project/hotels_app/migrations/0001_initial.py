    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotels_app.booking')),
            ],
        ),
        migrations.AddField(
            model_name='booking',
            name='reservation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hotels_app.room'),
        ),
        migrations.AddField(
            model_name='booking',
            name='reservee',
