...
class RoomType(models.Model):
    ...
    hotel_rt = models.OneToOneField(Hotel, on_delete=models.CASCADE,
                                    related_name="hotel_room_type", verbose_name='ID Hotel')
...
class Room(models.Model):
    ...
    hotel_r = models.OneToOneField(Hotel, on_delete=models.CASCADE, related_name="hotel_room", verbose_name='ID Hotel')
    rt_r = models.OneToOneField(RoomType, on_delete=models.CASCADE, related_name="rt_room", verbose_name='ID Room type')
