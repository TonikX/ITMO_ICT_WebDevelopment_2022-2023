<template>
  <base-layout>
    <retrieve-room :review_room="room.review_room" :number_room="room.number_room" :status_room="room.status_room" :des_rt="room.rt_r.des_rt" :price_rt="room.rt_r.price_rt" :type_rt="room.rt_r.type_rt" :name_hotel="room.hotel_r.name_hotel" />
    <h3>Comments:</h3>
