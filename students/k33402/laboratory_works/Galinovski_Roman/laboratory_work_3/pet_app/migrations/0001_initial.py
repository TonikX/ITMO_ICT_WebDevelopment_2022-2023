# Generated by Django 4.1.3 on 2023-03-04 16:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show_exp', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='show_exp_reg_participation', related_query_name='show_exp_reg', to='pet_app.exhibition', verbose_name='Exhibition')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sponsor_show', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sponsor_show', related_query_name='sponsor_show', to='pet_app.exhibition', verbose_name='Exhibition')),
            ],
        ),
        migrations.CreateModel(
            name='Schedule',
            fields=[
                ...
                ('show_schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='show_schedule', related_query_name='show_schedule', to='pet_app.exhibition', verbose_name='Exhibition')),
            ],
        ),
        migrations.CreateModel(
            name='Grading',
            fields=[
                ...
                ('dog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dog', related_query_name='dog', to='pet_app.dogregistered', verbose_name='Dog')),
                ('expert', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expert', related_query_name='expert', to='pet_app.expertregistered', verbose_name='Expert')),
                ('schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedule', related_query_name='schedule', to='pet_app.schedule', verbose_name='Schedulle')),
            ],
        ),
        migrations.AddField(
            model_name='dogregistered',
            name='show_dog',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='show_reg_dog_participation', related_query_name='show_dog_reg', to='pet_app.exhibition', verbose_name='Exhibition'),
        ),
        migrations.AddField(
            model_name='dog',
            name='owner',
