...
urlpatterns = [
    ...
    path("show/<int:pk>/", ExhibitionAPIView.as_view()),
    path("show/create/", ExhibitionCreateAPIView.as_view()),
    path("dog_reg/", DogRegisteredListAPIView.as_view()),
    path("dog_reg/<int:pk>/", DogRegisteredAPIView.as_view()),
    ...
    path("expert_reg/", ExpertRegisteredListAPIView.as_view()),
    path("expert_reg/<int:pk>/", ExpertRegisteredAPIView.as_view()),
    path("expert_reg/create/", ExpertRegisteredCreateAPIView.as_view()),
