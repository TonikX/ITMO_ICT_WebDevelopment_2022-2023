...
from megaultrabooking.views import hotels_list, rooms_list, reviews_list, register_user, add_hotel, add_room, add_review, add_booking, bookings_list, personal_page, edit_booking, hotel_statistics
