...
carOwners.append(
    CarOwner.objects.create(username="owner1", last_name="Ivanov", first_name="Ivan", date_of_birth="1990-12-11",
                            passport_number="4013888001", address="Saint Petersburg, ul. Pushkina, d. 1"))
carOwners.append(
    CarOwner.objects.create(username="owner2", last_name="Petrov", first_name="Petr", date_of_birth="1990-11-11",
                            passport_number="4013888002", address="Saint Petersburg, ul. Pushkina, d. 2"))
carOwners.append(
    CarOwner.objects.create(username="owner3", last_name="Danilov", first_name="Danil", date_of_birth="1990-10-11",
                            passport_number="4013888003", address="Saint Petersburg, ul. Pushkina, d. 3"))
carOwners.append(
    CarOwner.objects.create(username="owner4", last_name="Glebov", first_name="Gleb", date_of_birth="1990-09-11",
                            passport_number="4013888004", address="Saint Petersburg, ul. Pushkina, d. 4"))
carOwners.append(
    CarOwner.objects.create(username="owner5", last_name="Sergeev", first_name="Sergei", date_of_birth="1990-08-11",
                            passport_number="4013888005", address="Saint Petersburg, ul. Pushkina, d. 5"))
carOwners.append(
    CarOwner.objects.create(username="owner6", last_name="Maksimov", first_name="Maksimov", date_of_birth="1990-07-11",
                            passport_number="4013888006", address="Saint Petersburg, ul. Pushkina, d. 6"))
carOwners.append(
    CarOwner.objects.create(username="owner7", last_name="Artemov", first_name="Artem", date_of_birth="1990-06-11",
                            passport_number="4013888007", address="Saint Petersburg, ul. Pushkina, d. 7"))
...
for owner in carOwners:
    licenses.append(DrivingLicense.objects.create(id_owner=owner, license_number="0001111101", type="B",
                                                  date_of_issue="2013-08-08"))
