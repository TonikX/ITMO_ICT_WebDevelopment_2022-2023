...
class Currency(models.Model):
    ...
    price = models.DecimalField(verbose_name="Цена за единицу")
    ...
    date_added = models.DateField(verbose_name="Дата появления", auto_now=True)
    coinlib_id = models.PositiveIntegerField(verbose_name="Id на сайте Coinlib.io", max_length=5)
    image = models.CharField(verbose_name="Ссылка на изображение")
...
class Discussion(models.Model):
    ...
    date_added = models.DateField(verbose_name="Дата публикации", auto_now=True)
