          ...
          <div class="signIn signIn__wrapper">
            ...
            <form
              ...
              <v-text-field
                  ...
                  type="password"
              ></v-text-field>
              <!--      <input type="text" label="login" placeholder="login" v-model="login" name="login" class="input">-->
              <!--      <input label="password" placeholder="password" v-model="password" name="password" type="password" class="input">-->
