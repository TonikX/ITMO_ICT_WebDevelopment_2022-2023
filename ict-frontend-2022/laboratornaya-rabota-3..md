...
### Вариант 1 по web: Са**йт администратора отеля**
...
Во время выполнения этой лабораторной я получил новые знания по работе с фреймворком Vue, распредилил компоненты и подклютил роутер.
